...
function TransferWithdrawalsspinsol() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "Transfer Withdrawals Spin SOL");
      XLSX.writeFile(workbook, "Transfer_Withdrawals_Spin_SOL.xlsx");
  ...
  return (
    <Box className={classes.main}>
      <Box className="displaySpacebetween">
        <GoBack title="Transfer Withdrawals Spin SOL" />
        <Button
          variant="contained"
          color="primary"
      ...
      <Box mt={3} mb={3}>
        <Paper elevation={3}>
          <Filtter
            ...
            excelTableName="Transfer Withdrawals Spin sol"
            apiEndPoint="Pending"
          />
        </Paper>
      </Box>
