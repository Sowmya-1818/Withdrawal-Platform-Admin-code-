...
function Approvedwithdrawaldrivesol() {
  let filterData = {};
  ...
  const settings = async () => {
    try {
      ...
      console.log(tokenmint, "tokenmint in settings");
  ...
  useEffect(() => {
    ...
    // settings();
    console.log("dgdfhfgjhfgjhfghxfh");
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "Approved Withdrawals Drive SOL");
      XLSX.writeFile(workbook, "Approved_Withdrawals_Drive_SOL.xlsx");
    } catch (error) {
  ...
  return (
    <Box className={classes.main}>
      <Box className="displaySpacebetween">
        <GoBack title={"Approved Withdrawals Drive Sol"} />
...
export default Approvedwithdrawaldrivesol;
